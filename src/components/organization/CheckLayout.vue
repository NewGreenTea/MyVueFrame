                      ...
                      <Row>
                        <Col>
                          <p>
                            ...
                            <span v-if="buildingAddressInfo!== null"
                                  class="displaySpan"> {{buildingAddressInfo.area}}</span>
                            <!--<Input placeholder="..." v-model="buildingAddressInfo.road" class="writeInput"/>-->
                            <span v-if="buildingAddressInfo!== null"
                                  class="displaySpan">{{buildingAddressInfo.road}}</span>
                            <!--<Input placeholder="..." v-model="buildingAddressInfo.street" class="writeInput"/>-->
                            <span v-if="buildingAddressInfo!== null"
                                  class="displaySpan">{{buildingAddressInfo.street}}</span>
                            <!--<Input placeholder="..." v-model="buildingAddressInfo.no" class="writeInput"/>-->
                            <span v-if="buildingAddressInfo!== null"
                                  class="displaySpan">{{buildingAddressInfo.no}}</span>
                          </p>
                        </Col>
                      </Row>
                    </FormItem>
                    ...
                    <Row>
                      ...
                      <Col span="12">
                        <FormItem class="FormItemClass" label="总长度：">
                          ...
                          {{(D32Info !== null && D32Info.bridgeTotalLength !== null)? D32Info.bridgeTotalLength
                          +'（m/米）': ''}}
                        </FormItem>
                      </Col>
                      <Col span="12">
                    ...
                    <Row>
                      ...
                      <Col span="12">
                        <FormItem class="FormItemClass" label="管线长度：">
                          ...
                          {{(D34Info !== null && D34Info.overheadPipeLength !== null)? D34Info.overheadPipeLength
                          +'（m/米）': ''}}
                        </FormItem>
                      </Col>
                      <Col span="12">
                        <FormItem class="FormItemClass" label="架空高度：">
                          ...
                          {{(D34Info !== null && D34Info.overheadPipeHight !== null)? D34Info.overheadPipeHight
                          +'（m/米）': ''}}
                        </FormItem>
                      </Col>
                      <Col span="12">
                    ...
                    <Row>
                      ...
                      <Col span="12">
                        <FormItem class="FormItemClass" label="管线长度：">
                          ...
                          {{(D63Info !== null && D63Info.overheadPipeLength !== null)? D63Info.overheadPipeLength
                          +'（m/米）': ''}}
                        </FormItem>
                      </Col>
                      <Col span="12">
                        <FormItem class="FormItemClass" label="架空高度：">
                          ...
                          {{(D63Info !== null && D63Info.overheadPipeHight !== null)? D63Info.overheadPipeHight
                          +'（m/米）': ''}}
                        </FormItem>
                      </Col>
                      <Col span="12">
