      ...
      <Form class="formClass" :model="D31BuildProjInfo" ref="addForm" :rules="rules">
        <Row>
          <Col>
            <Row>
              <Col span="8">
                <FormItem class="FormItemClass" label="申报项目名称">
                  <Input placeholder="..." v-model="D31BuildProjInfo.projectName" class="writeInput"/>
                </FormItem>
              </Col>
              <Col span="8">
                <FormItem class="FormItemClass" label="幢数" prop="buildingNum">
                  <Input placeholder="..." v-model="D31BuildProjInfo.buildingNum" class="writeInput"/>
                </FormItem>
              </Col>
              <Col span="8">
                <FormItem class="FormItemClass" label="地上层数" prop="overgroundFloor">
                  <Input placeholder="..." v-model="D31BuildProjInfo.overgroundFloor" class="writeInput"/>
                </FormItem>
              </Col>
            </Row>
            ...
            <Row>
              <Col span="8">
                <FormItem class="FormItemClass" label="地下层数" prop="undergroundFloor">
                  <Input placeholder="..." v-model="D31BuildProjInfo.undergroundFloor" class="writeInput"/>
                </FormItem>
              </Col>
              <Col span="8">
                <FormItem class="FormItemClass" label="地上面积" prop="overgroundArea">
                  <Input placeholder="..." v-model="D31BuildProjInfo.overgroundArea" class="writeInput"/>
                </FormItem>
              </Col>
              <Col span="8">
                <FormItem class="FormItemClass" label="地下面积" prop="undergroundArea">
                  <Input placeholder="..." v-model="D31BuildProjInfo.undergroundArea" class="writeInput"/>
                </FormItem>
              </Col>
              <Col span="8">
                <FormItem class="FormItemClass" label="总建筑面积" prop="totalArea">
                  <Input placeholder="..." v-model="D31BuildProjInfo.totalArea" class="writeInput"/>
                </FormItem>
              </Col>
            </Row>
          </Col>
